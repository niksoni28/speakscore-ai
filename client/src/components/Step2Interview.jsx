  ...
  <h2 className='text-xl sm:text-2xl font-bold text-emerald-600 mb-6'>
   ...
   { !isIntroPhase && (
    ...
    {!feedback ? (<div className='flex items-center gap-4 mt-6'>
      ...
      items-center justify-center rounded-full bg-black text-white shadow-lg'>
      ...
      className='mt-6 bg-emerald-50 border border-emerald-200 p-5 rounded-2xl shadow-sm'>
        ...
        <button 
        onClick={handleNext}
        className='w-full bg-gradient-to-r from-emerald-600 to-teal-500 text-white py-3 rounded-xl shadow-md
         hover:opacity-90 transition flex item-center justify-center gap-1'>
