...
doc.text(
  ...
  advice ="Excellent performance. Maintain confidence and structure. Continue refining clarity and supporting answers with strong real-world examples.";
    ...
    advice = "Good foundation shown. Imporve Clarity and structure. Practise delivering conscise, confident answer with stronger supporting examples.";
} else {
