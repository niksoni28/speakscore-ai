...
export const analyzeResume = async (req , res) => {
  ...
  {
    role: "system",
    content: `Extract structured data from the resume text provided by the user.
Return strictly valid JSON in exactly this shape, with no extra text or markdown:
...
Strict Rules:
-Ensure the first interview question is always "Tell me something about yourself" and the rest from projects and skills
...
-Question must sound genuine not like AI-generated, all question must be relevant to project and skills.
...
Make questions Strictly based on the candidate's role, experience, interviewMode, projects, skills, and resume details.`
},
